...
Normalized_Counts_New <- function(Filtered_Counts_New, ccbr699_metadata_for_NIDAP) {
...
counts_matrix[,gene_names_column]=paste0(counts_matrix[,gene_names_column],'_',1:nrow(counts_matrix))
    ...
    png(
      filename="Normalized_Counts_New.png",
      width=imageWidth,
      height=imageHeight,
      units="px",
      pointsize=4,
...
print("template_function_Normalized_Counts_New.R #########################################################################")
...
var_Normalized_Counts_New<-Normalized_Counts_New(var_Filtered_Counts_New,var_ccbr699_metadata_for_NIDAP)
invisible(graphics.off())
saveRDS(var_Normalized_Counts_New, paste0(rds_output,"/var_Normalized_Counts_New.rds"))
