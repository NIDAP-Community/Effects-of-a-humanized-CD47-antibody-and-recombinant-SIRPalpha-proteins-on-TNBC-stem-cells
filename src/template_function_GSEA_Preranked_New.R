...
GSEA_Preranked_New <- function(DEG_Analysis_New, msigdb_v6_2_with_orthologs) {
...
#image: png
png(
  filename = "GSEA_Preranked_New.png",
  width = image_width,
  height = image_height,
  units = "px",
  pointsize = 4,
...
print("template_function_GSEA_Preranked_New.R #########################################################################")
...
var_GSEA_Preranked_New<-GSEA_Preranked_New(var_DEG_Analysis_New,var_msigdb_v6_2_with_orthologs)
invisible(graphics.off())
saveRDS(var_GSEA_Preranked_New, paste0(rds_output,"/var_GSEA_Preranked_New.rds"))
