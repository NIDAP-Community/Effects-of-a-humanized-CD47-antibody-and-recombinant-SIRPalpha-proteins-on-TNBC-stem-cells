...
DEG_Analysis_New <- function(Filtered_Counts_New, ccbr699_metadata_for_NIDAP) {
    ...
    #Basic Parameters:
    counts_matrix <- Filtered_Counts_New 
    ...
    contrasts<-c("Cg_231_A_72h-Ig_231_A_72h","Cg_231_A_72h-Ut_231_A_72h","Si_231_A_72h-Ig_231_A_72h","Si_231_A_72h-Ut_231_A_72h")
...
print("template_function_DEG_Analysis_New.R #########################################################################")
library(plotly);library(ggplot2);library(jsonlite);
currentdir <- getwd()
rds_output <- paste0(currentdir,'/rds_output')
var_Filtered_Counts_New<-readRDS(paste0(rds_output,"/var_Filtered_Counts_New.rds"))
Input_is_Seurat_count <- 0
for(item in var_Filtered_Counts_New){ if (class(item)=="Seurat"){Input_is_Seurat_count = Input_is_Seurat_count + 1}}
if(Input_is_Seurat_count == 0 ){
var_Filtered_Counts_New<-as.data.frame(var_Filtered_Counts_New)}else{var_Filtered_Counts_New <- var_Filtered_Counts_New}
currentdir <- getwd()
rds_output <- paste0(currentdir,'/rds_output')
...
var_DEG_Analysis_New<-DEG_Analysis_New(var_Filtered_Counts_New,var_ccbr699_metadata_for_NIDAP)
invisible(graphics.off())
saveRDS(var_DEG_Analysis_New, paste0(rds_output,"/var_DEG_Analysis_New.rds"))
